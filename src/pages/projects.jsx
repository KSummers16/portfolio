        ...
        <div className="project-info">
          ...
          <div className="project-details">
            <p>
              ...
              enhance and expand the site. Built using Django, Python, React,
              and CSS, this platform is designed for my small crochet business.
              It allows customers to purchase pre-made products ready for
              immediate shipping and provides an option for custom product
              requests, where customers can specify details such as colors and
              eye styles. I have also deployed this site using DigitalOcean,
              though it is not in use by my customers yet.
            </p>
            <p>
              GitHub Repo:{" "}
        ...
        <div className="project-info">
          ...
          <div className="project-details">
            <p>
              ...
              implement new features. In addition to resolving and testing
              current bugs, all pull requests required peer review and approval
              before integration into the main codebase. I contributed by
              developing a feature that enabled users to create storefronts and
              display them, resolving a bug that incorrectly displayed all
              payments instead of just the user's payments, and generating the
              unpaid orders report. This project involved the use of React, CSS,
              Django, and Python.
            </p>
            <p>
              GitHub Repo:{" "}
